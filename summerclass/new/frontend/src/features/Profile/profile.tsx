    ...
    <div className="profile-main-container">
      ...
      <div className="profile-details-grid">
        ...
        <div className="profile-detail">
          ...
          <input type="text" value={user.nickname || ''} placeholder="Last Name" readOnly />
        </div>
        <div className="profile-detail">
          <label>Gender</label>
        ...
        <div className="profile-detail">
          <label>Address</label>
          <input type="text" value={user.address || ''} placeholder="Address" readOnly />
        </div>
        <div className="profile-detail">
        ...
        <div className="profile-detail">
          <label>Company</label>
          <input type="text" value={user.company || ''} placeholder="Company" readOnly />
        </div>
      </div>
      ...
      <div className="profile-section">
        ...
        <div className="profile-email-box">
          ...
          <div>
            ...
            <div className="profile-email-meta">work email</div>
          </div>
        </div>
